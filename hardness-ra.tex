...
A concrete example of the reduction is presented below.
\paragraph*{Illustrate the reduction}\label{app:hardness-example}
\input{fine-grained-example.tex}
\input{example-tikz.tex} 
